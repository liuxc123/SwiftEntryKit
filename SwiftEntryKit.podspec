...
DESC
  s.homepage         = 'https://github.com/liuxc123/SwiftEntryKit'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Liuxc' => 'lxc_work@126.com' }
  s.source           = { :git => 'https://github.com/liuxc123/SwiftEntryKit.git', :tag => s.version.to_s }
